...
public class InitChangelog {
    ...
    public void addComments(CommentRepository commentRepository,
                            ...
                            AclServiceWrapper aclServiceWrapper) {
        ...
        addCommentToAcl(authenticationManager, aclServiceWrapper, comments);
    }

    private static void addCommentToAcl(AuthenticationManager authenticationManager,
                                        AclServiceWrapper aclServiceWrapper,
        ...
        comments.forEach(aclServiceWrapper::addCommentToAcl);
    }
}
