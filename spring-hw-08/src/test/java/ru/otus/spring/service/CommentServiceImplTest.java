...
class CommentServiceImplTest {
    ...
    private final String BOOK_1_ID = "1";
    private final String BOOK_1_NAME = "Book 1";
    private final String COMMENT_1_ID = "1";
    ...
    private List<Comment> getByBookId(String bookId) {
    ...
    private Optional<Comment> getById(String id) {
