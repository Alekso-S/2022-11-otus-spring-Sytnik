...
class BookRepositorySpringDataTest {
    ...
    void shouldFindByGenreName() {
        assertThat(bookRepository.findAllByGenresName(GENRE_1_NAME)).hasSameElementsAs(getAllByGenreName(GENRE_1_NAME));
    ...
    private Optional<Author> getAuthorByName(String authorName) {
        return DataProducer.getAuthorByName(authorName);
    }
